...
public class AirportDtos {
    ...
    public record AirportResponse(Long id, String code, String name, String city, List<FlightDtos.FlightResponse> departures,
                                  List<FlightDtos.FlightResponse> arrivals) implements Serializable {}
}
